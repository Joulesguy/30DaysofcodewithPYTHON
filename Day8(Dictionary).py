# Day 8 - 30DaysOfPython Challenge by Swift Cyberwatch
## Dictionaries
...
# Accessing an item by key name raises an error if the key does not exist. To avoid this error 
# first we have to check if a key exist or we can use the _get_ method. The get method returns None, 
